 ...
 * @author vicken
 */
public class OrderDispatchedEmail {
    ...
    public static void main(String[] args) throws Exception {
        OrderDispatchedEmail.orderDispatched(toEmail);
    }
    
    
    public static void orderDispatched(String recipient) throws Exception{
        ...
        Message message = dispatchedMessage(session, fromEmail, recipient);
    ...
    private static Message dispatchedMessage(Session session, String email, String recipient) {
        try {
            Message message = new MimeMessage(session);
            message.setFrom(new InternetAddress(email));
            
            message.setRecipient(Message.RecipientType.TO, new InternetAddress(toEmail));
            message.setSubject("Animal Rescue Shipping Update - DISPATCHED");
            message.setText("Hello valued user, thank you for your purchase from the Animal Rescure website!\n\n"+
                    "This email is to inform you that our driver is currently on the way to drop off your order!\n\n"+
